...
def _prepare_tk_library_paths() -> None:
    ...
    def use_tk_paths(tcl_path: str, tk_path: str) -> bool:
        ...
        tcl_can_read = _tcl_runtime_can_read(safe_init) and _tcl_runtime_can_read(
            safe_tk_script
        )
        ascii_safe = is_ascii_path(tcl_env) and is_ascii_path(tk_env)
        if files_exist and (tcl_can_read or ascii_safe):
